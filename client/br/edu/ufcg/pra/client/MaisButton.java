...
public class MaisButton extends Button {
	...
	public MaisButton(String cursor, final ArrayList<Pedido> listaa, final CellTable table) {
		          ...
		          Request request = builder5.sendRequest(null, new RequestCallback() {
		            ...
		            public void onResponseReceived(Request request, Response response) {
		              if (200 == response.getStatusCode()) {
		            	 ...
		            	 removeFromParent();
		            	 RootPanel.get("main_bottom").add(new MaisButton(lista.getCursor(), listaa, table));
