...
lista_usuarios = [users.User("clovis.de.melo@hotmail.com"),users.User("isaac.almeida@ufcg.edu.br"),
                 users.User("eliasalmox@ufcg.edu.br"),users.User("fatima.pereira@ufcg.edu.br"),
